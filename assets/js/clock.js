document.addEventListener('DOMContentLoaded', function () {
    var yvClock =
        {
            showClock: function (canvas, fillColor, strokeColor) {
                ...
                var timerId = setInterval(function () {
                    yvClock.timerProc(context, drawParams,
            ...
            timerProc: function (context, drawParams, fillColor, strokeColor) {
                ...
                var hours12 = (hours > 11) ? hours - 12 : hours;
    ...
    yvClock.showClock(document.getElementById("first"),'#C6BEB5', "#6B0000");
});