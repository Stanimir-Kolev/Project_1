...
function w(a,b){if(b){for(var c=k,e=a.split("."),d=0;d<e.length-1;d++){var f=e[d];f in c||(c[f]={});c=c[f]}e=e[e.length-1];d=c[e];f=b(d);f!=d&&null!=f&&g(c,e,{configurable:!0,writable:!0,value:f})}}
w("String.prototype.endsWith",function(a){return a?a:function(a,c){var b=v(this,a,"endsWith");a+="";void 0===c&&(c=b.length);for(var d=Math.max(0,Math.min(c|0,b.length)),f=a.length;0<f&&0<d;)if(b[--d]!=a[--f])return!1;return 0>=f}});
w("String.prototype.startsWith",function(a){return a?a:function(a,c){var b=v(this,a,"startsWith");a+="";for(var d=b.length,f=a.length,r=Math.max(0,Math.min(c|0,b.length)),h=0;h<f&&r<d;)if(b[r++]!=a[h++])return!1;return h>=f}});
function x(a,b){return Object.prototype.hasOwnProperty.call(a,b)}
w("WeakMap",function(a){function b(a){this.a=(f+=Math.random()+1).toString();if(a){l();n();a=t(a);for(var b;!(b=a.next()).done;)b=b.value,this.set(b[0],b[1])}}
...
w("Set",function(a){function b(a){this.a=new Map;if(a){a=t(a);for(var b;!(b=a.next()).done;)this.add(b.value)}this.size=this.a.size}
...
return b});
var y=this;function z(a,b){var c=a.split("."),e=y;c[0]in e||!e.execScript||e.execScript("var "+c[0]);for(var d;c.length&&(d=c.shift());)c.length||void 0===b?e[d]&&e[d]!==Object.prototype[d]?e=e[d]:e=e[d]={}:e[d]=b}
...
;var E=Object.freeze(["js-httpswwwgoogleanalyticscomanalyticsjs","js-chromeextensionpkedcjkdefgpdelpbcmbmeomcjbeemfm","video-","js-http","css-http"]),F=Object.freeze("document.appendChild document.body.appendChild document.querySelector document.querySelectorAll history.back history.go".split(" ")),G=Object.freeze(["securepubads.g.doubleclick.net","www.youtube.com","youtube.com"]),H=Object.freeze(["pkedcjkdefgpdelpbcmbmeomcjbeemfm","fjhoaacokmgbjemoflkofnenfaiekifl"]),I=Object.freeze(".corp.google.com .googlevideo.com .ytimg.com .google.com .googlesyndication.com .gstatic.com .prod.google.com".split(" ")),
J=Object.freeze(["chrome-extension","safari-extension","safari-resource","opera"]);function K(){return F.map(function(a){return L(a)}).filter(function(a){return!!a})}
...
;z("ytbin.polymer.shared.lib.tampering.info",function(){var a=T(),b=P(),c=K(),e=Q();return a.length||b.length||c.length||e.length?{extensions:e,suspiciousClasses:a,suspiciousIncludes:b,suspiciousApis:c}:null});}).call(this);
